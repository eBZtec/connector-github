...
import org.kohsuke.github.EMUSeat;
import org.kohsuke.github.EMUSeatAssigningTeam;
...
public class GitHubEMUSeatHandler extends AbstractGitHubEMUHandler {

    public static final ObjectClass SEAT_OBJECT_CLASS = new ObjectClass("EMUSeat");

    private static final Log LOGGER = Log.getLog(GitHubEMUSeatHandler.class);

    public GitHubEMUSeatHandler(GitHubEMUConfiguration configuration, GitHubClient<GitHubEMUSchema> client,
    ...
    public static SchemaDefinition.Builder createSchema(AbstractGitHubConfiguration configuration, GitHubClient<GitHubEMUSchema> client) {
        SchemaDefinition.Builder<EMUSeat, SCIMPatchOperations, EMUSeat> sb
                = SchemaDefinition.newBuilder(SEAT_OBJECT_CLASS, EMUSeat.class, SCIMPatchOperations.class, EMUSeat.class);
    ...
    public int getByUid(Uid uid, ResultsHandler resultsHandler, OperationOptions options, Set<String> returnAttributesSet, Set<String> fetchFieldsSet, boolean allowPartialAttributeValues, int pageSize, int pageOffset) {
        EMUSeat seat = client.getEMUSeat(uid, options, fetchFieldsSet);
    ...
    public int getByName(Name name, ResultsHandler resultsHandler, OperationOptions options, Set<String> returnAttributesSet, Set<String> fetchFieldsSet, boolean allowPartialAttributeValues, int pageSize, int pageOffset) {
        EMUSeat seat = client.getEMUSeat(name, options, fetchFieldsSet);
    ...
    public int getAll(ResultsHandler resultsHandler, OperationOptions options, Set<String> returnAttributesSet, Set<String> fetchFieldsSet, boolean allowPartialAttributeValues, int pageSize, int pageOffset) {
        return client.getEMUSeats((s) -> resultsHandler.handle(toConnectorObject(schemaDefinition, s, returnAttributesSet, allowPartialAttributeValues)),
