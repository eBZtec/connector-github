 ...
 */
public class SeatPageIterator<T extends SeatSearchResult> implements Iterator<T> {
    ...
    private SeatPageIterator(GitHubClient client, Class<T> type, GitHubRequest request) {
    ...
    static <T extends SeatSearchResult> SeatPageIterator<T> create(GitHubClient client, Class<T> type, GitHubRequest request, int pageSize, int pageOffset) {
        ...
        try {
            ...
            return new SeatPageIterator<>(client, type, request);
